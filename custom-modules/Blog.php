...
class WMT_Builder_Module_Blog extends ET_Builder_Module_Type_PostBased {
	function init() {
	...
	function get_fields() {
		$fields = array(
			...
			'include_author' => array(
				'label'             => esc_html__( 'Include Author', 'et_builder' ),
				'type'              => 'text',
				'option_category'   => 'configuration',
				'description'       => esc_html__( 'Choose which author you would like to include in the feed.', 'et_builder' ),
				'toggle_slug'      => 'main_content',
				'computed_affects' => array(
					'__posts',
				),				
	...
	static function get_blog_posts( $args = array(), $conditional_tags = array(), $current_page = array() ) {
		...
		if ( '' !== $args['include_author'] ) {
			$query_args['author'] = $args['include_author'];
		}
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$include_author		 = $this->shortcode_atts['include_author'];
