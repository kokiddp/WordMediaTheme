...
class WMT_Builder_Module_WM_Fullwidth_MenuBar extends ET_Builder_Module {
	function init() {
		$this->name       = esc_html__( 'WordMedia Fullwidth MenuBar', 'wordmedia' );
		$this->slug       = 'et_pb_wm_fullwidth_menubar';
		$this->fullwidth  = true;
		...
		$this->main_css_element = '%%order_class%%.et_pb_wm_fullwidth_menubar';
	...
	function get_fields() {
		...
		$fields = array(
			'id' => array(
				'label'           => esc_html__( 'WordMedia Fullwidth MenuBar', 'wordmedia' ),
				'type'            => 'select',
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$output = sprintf(
			'<div%1$s class="et_pb_module et_pb_wm_fullwidth_menubar%2$s">
				%3$s
			</div>',
			$module_id,
			$module_class,
